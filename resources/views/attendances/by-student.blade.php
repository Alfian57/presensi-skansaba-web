...
@section('content')
    ...
    <h2 class="text-center mt-3">Presensi {{ $student->user->name ?? $student->name }}</h2>

    <div class="card mt-4">
        <div class="card-header">
            <p class="mb-0">
                <strong>NISN:</strong> {{ $student->nisn }} |
                <strong>Kelas:</strong> {{ $student->classroom->name ?? '-' }}
            </p>
        </div>
        <div class="card-body">
    ...
    <div class="mt-3">
        <a href="{{ route('dashboard.attendances.recap.student') }}" class="btn btn-secondary">

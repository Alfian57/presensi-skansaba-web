...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <x-ui.card title="Ubah Data Guru" icon="fas fa-user-edit">
                <form action="{{ route('dashboard.teachers.update', $teacher->nip) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($teacher->user->profile_picture)
                            <img src="{{ asset('storage/' . $teacher->user->profile_picture) }}" alt="Profile" class="d-block mb-2 rounded" style="max-width: 150px;">
                    ...
                    <x-forms.actions :backRoute="route('dashboard.teachers.index')" submitLabel="Perbarui Data" />
                </form>
            </x-ui.card>
        </div>
    </div>

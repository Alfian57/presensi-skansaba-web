...
@section('content')
    ...
    <div class="row mt-3">
        <div class="col-md-4">
            <x-ui.card title="Foto & Informasi Dasar" headerClass="bg-primary text-white">
                <div class="text-center">
                    ...
                    <x-ui.badge :type="$teacher->user->is_active ? 'active' : 'inactive'" class="mb-3">
                        {{ $teacher->user->is_active ? 'Aktif' : 'Tidak Aktif' }}
                    </x-ui.badge>
                    
                    <div class="text-start mt-4">
                        <table class="table table-borderless table-sm">
                            <tr><th width="40%">Email</th><td>: {{ $teacher->user->email }}</td></tr>
                            <tr><th>Username</th><td>: {{ $teacher->user->username ?? '-' }}</td></tr>
                            <tr><th>No. Telepon</th><td>: {{ $teacher->phone ?? '-' }}</td></tr>
                            <tr><th>Jenis Kelamin</th><td>: {{ $teacher->gender == App\Enums\Gender::MALE->value ? "Laki-laki" : "Perempuan" }}</td></tr>
                        </table>
                    </div>
                    ...
                    <div class="text-end mt-3">
                        ...
                        <a href="{{ route('dashboard.teachers.edit', $teacher) }}" class="btn btn-warning btn-sm">
        ...
        <div class="col-md-8">
                ...
                @else
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <thead>
                                <tr><th>#</th><th>Hari</th><th>Mata Pelajaran</th><th>Kelas</th><th>Waktu</th></tr>
                            </thead>
                            <tbody>
            ...
            @php $homeroom = $teacher->homeroomTeacher; @endphp
            @if($homeroom)
                <x-ui.card title="Wali Kelas" headerClass="bg-warning text-white">

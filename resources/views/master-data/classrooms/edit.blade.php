...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <x-ui.card title="Ubah Data Kelas" icon="fas fa-school">
                <form action="{{ route('dashboard.classrooms.update', $classroom->slug) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-forms.select name="grade_level" label="Tingkat" :options="['10' => '10', '11' => '11', '12' => '12']" :value="$classroom->grade_level" placeholder="-- Pilih Tingkat --" required />
                        </div>
                        <div class="col-md-6">
                            <x-forms.input name="major" label="Jurusan / Program" placeholder="Masukkan jurusan" :value="$classroom->major" />
                        </div>
                    </div>
                    ...
                    <x-forms.actions :backRoute="route('dashboard.classrooms.index')" submitLabel="Perbarui Data" />
                </form>
            </x-ui.card>
        </div>
    </div>

        ...
        <div class="row">
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('academic_year') is-invalid @enderror" 
                    ...
                    placeholder="2022/2023" value="{{ old('academic_year') }}" required autofocus>
                @error('academic_year')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('room') is-invalid @enderror" name="room" id="room"
                    placeholder="Contoh: Lab Komputer" value="{{ old('room') }}" required maxlength="100">
                @error('room')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
